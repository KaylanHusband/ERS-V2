...
<body>
	...
	<div class = "row justify-content-center"><h1 class = "display-4">Submit Request</h1></div>
		...
		<s:form action = "emp-create-reimb-form">
			<s:textfield name = "reAmount" min="0.01" step="0.01" type = "number" placeholder = "Amount"/>
			<s:textfield name = "description" placeholder = "Description"/>
			<s:submit/>
			<input type = "button" class = "btn btn-secondary" value = "Return To Employee Home" onclick ="window.location.href = 'emp-home';"/>
		</s:form>
		</div>
	</div>
