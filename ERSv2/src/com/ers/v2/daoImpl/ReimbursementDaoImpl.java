...
import com.ers.v2.dao.ReimbursementDao;
...
public class ReimbursementDaoImpl implements ReimbursementDao {
	...
	public boolean createReimbursement(Reimbursement r) {
		...
		String sql = "insert into ersv2.reimbursement (reimbursement_amount,description,employee_id) values(?,?,?)";
	...
	public List<Reimbursement> employeeGetReimbursement(int id) {
		String sql = "Select * from ersv2.reimbursement where employee_id = ? and reimbursement_status isnull";
	...
	public List<Reimbursement> reimbursementWithEmpName() {
		String sql = "select ersv2.employee.employee_name, \r\n" + 
	...
	public boolean approveReimbursement(int id,int id2) {
		...
		String sql = "update ersv2.reimbursement\r\n" + 
				"set reimbursement_status = 'approved'\r\n" + 
				"where reimbursement_id =?;";
		String sql2 = "update ersv2.reimbursement\r\n" + 
	...
	public List<Reimbursement> deniedReimbursementWithEmpName() {
		String sql = "select ersv2.employee.employee_name, \r\n" + 
				...
				"where ersv2.reimbursement.reimbursement_status = 'denied';";
	...
	String sql = "Select * from ersv2.reimbursement where employee_id = ? and reimbursement_status = 'approved'";
	List<Reimbursement> embs = new ArrayList<>();
	...
	public List<Reimbursement> approvedReimbursementWithEmpName() {
		String sql = "select ersv2.employee.employee_name, \r\n" + 
				...
				"inner join ersv2.employee on ersv2.employee.employee_id = ersv2.reimbursement.employee_id\r\n" + 
				"inner join ersv2.manager on ersv2.reimbursement.manager_id = ersv2.manager.manager_id\r\n" + 
				"where ersv2.reimbursement.reimbursement_status = 'approved';";
	...
	public List<Reimbursement> getEmployeeDeniedReimbursement(int id) {
		String sql = "Select * from ersv2.reimbursement where employee_id = ? and reimbursement_status = 'denied'";
		List<Reimbursement> embs = new ArrayList<>();
