...
<body>
 <div class="container-fluid">
 	<div class = "row justify-content-center"><h3 class = "display-4">Denied Reimbursements</h3></div>
 </div>
...
<table id="man-denied-reimb-table" class="table">
	<tr>
		<th>Employee Name</th>
...
<script src="Js/ManagerViewDenied.js"></script>
</body>
</html>